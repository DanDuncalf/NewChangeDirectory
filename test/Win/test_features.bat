...
pushd "%TESTROOT%"
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% /r.'; if (-not $p.WaitForExit(30000)) { $p.Kill(); Write-Host 'WARN: Initial scan timed out' }" >nul 2>&1
popd
echo   Scan complete.
echo.
...
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% /r.'; if (-not $p.WaitForExit(15000)) { $p.Kill(); exit 1 } else { exit $p.ExitCode }" >nul 2>&1
...
pushd "%TESTROOT%\Projects"
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% /g @proj'; if (-not $p.WaitForExit(10000)) { $p.Kill(); exit 1 } else { exit $p.ExitCode }" >nul 2>&1
if not errorlevel 1 (call :pass H1 "Create group @proj") else (call :fail H1 "Create group @proj")
popd

:: H2: Create group @users
pushd "%TESTROOT%\Users"
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% /g @users'; if (-not $p.WaitForExit(10000)) { $p.Kill(); exit 1 } else { exit $p.ExitCode }" >nul 2>&1
...
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% /g @proj'; if (-not $p.WaitForExit(10000)) { $p.Kill() }" >nul 2>&1
popd
...
:: Clean up exclusions
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% -x- ""*/Deep""'; if (-not $p.WaitForExit(10000)) { $p.Kill() }" >nul 2>&1
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% -x- ""*/EmptyDrive""'; if (-not $p.WaitForExit(10000)) { $p.Kill() }" >nul 2>&1
...
pushd "%TESTROOT%"
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% /r. /d %CUSTOM_DB2%'; if (-not $p.WaitForExit(15000)) { $p.Kill() }" >nul 2>&1
popd
...
"%NCD%" /agent tree "%TESTROOT%\Projects" --json --depth 2 > "%TEMP%\v1_out.txt" 2>&1
findstr '"v":1' "%TEMP%\v1_out.txt" >nul && findstr '"tree":' "%TEMP%\v1_out.txt" >nul
...
"%NCD%" /agent tree "%TESTROOT%\Projects" --flat --depth 2 > "%TEMP%\v2_out.txt" 2>&1
...
"%NCD%" /agent tree "%TESTROOT%\Projects" --depth 2 > "%TEMP%\v3_out.txt" 2>&1
findstr /B " " "%TEMP%\v3_out.txt" >nul
...
"%NCD%" /agent tree "%TESTROOT%\Projects" --json --flat --depth 2 > "%TEMP%\v4_out.txt" 2>&1
findstr '"v":1' "%TEMP%\v4_out.txt" >nul && findstr '"d":' "%TEMP%\v4_out.txt" >nul
...
"%NCD%" /agent tree "%TESTROOT%" --depth 1 > "%TEMP%\v5_d1.txt" 2>&1
"%NCD%" /agent tree "%TESTROOT%" --depth 2 > "%TEMP%\v5_d2.txt" 2>&1
...
"%NCD%" /agent tree "%TESTROOT%\Users" --flat --depth 2 > "%TEMP%\v7_out.txt" 2>&1
...
"%NCD%" /agent tree "%TESTROOT%\Media" --json --depth 1 > "%TEMP%\v8_out.txt" 2>&1
findstr '"n":"' "%TEMP%\v8_out.txt" >nul && findstr '"d":0' "%TEMP%\v8_out.txt" >nul
...
"%NCD%" /agent tree "%TESTROOT%\Windows" --depth 2 > "%TEMP%\v9_out.txt" 2>&1
...
:rescan_testroot
pushd "%TESTROOT%"
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% /r.'; if (-not $p.WaitForExit(15000)) { $p.Kill() }" >nul 2>&1
popd
goto :eof
...
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% !TEOT_ARGS!'; if (-not $p.WaitForExit(%TEOT_TIMEOUT%000)) { $p.Kill(); exit 0 } else { exit $p.ExitCode }" >nul 2>&1
...
goto :teo_loop
:teo_run
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% !TEO_ARGS!'; if (-not $p.WaitForExit(10000)) { $p.Kill(); exit 1 } else { exit $p.ExitCode }" >nul 2>&1
...
goto :tef_loop
:tef_run
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% !TEF_ARGS!'; if (-not $p.WaitForExit(10000)) { $p.Kill(); exit 1 } else { exit $p.ExitCode }" >nul 2>&1
...
:tnf_run
del "%RESULT_FILE%" 2>nul
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% !TNF_ARGS!'; if (-not $p.WaitForExit(10000)) { $p.Kill(); exit 99 } else { exit $p.ExitCode }" >nul 2>&1
...
goto :tnn_loop
:tnn_run
powershell -NoProfile -Command "$env:LOCALAPPDATA='%LOCALAPPDATA%'; $env:NCD_TEST_MODE='1'; $p = Start-Process -PassThru -NoNewWindow -FilePath '%NCD%' -ArgumentList '%CONF_OVERRIDE% !TNN_ARGS!'; if (-not $p.WaitForExit(10000)) { $p.Kill(); exit 1 } else { exit $p.ExitCode }" >nul 2>&1
